...
<br />
This messaging Web Application is created using <strong>HTML, CSS, PHP, MySQL & JavaScript<strong/> . The app uses <strong>XAMPP<strong/>  to run offline and store all user signup data on a local web server on your computer.
